...
static const char * productString = "Freeverb3 "VERSION" [Rev2]";
static const char * configSectionString = "freeverb3_plugin_zrev2";

#ifdef PLUGDOUBLE
static fv3::zrev2_ DSP;
typedef fv3::utils_ UTILS;
#else
static fv3::zrev2_f DSP;
...
static void _odamh(pfloat_t t){DSP.setoutputhpf(t);};

static void _xol(pfloat_t t){DSP.setxover_low(t);};
static void _xoh(pfloat_t t){DSP.setxover_high(t);};
static void _rtl(pfloat_t t){DSP.setrt60_factor_low(t);};
static void _rth(pfloat_t t){DSP.setrt60_factor_high(t);};
...
static PluginParameterTable ppConfTable[] = {
  ...
  {"XOver Low", "XOL","[Hz]", "",0,10000, 2,   490, 0,true,true,false,kFloat,(void*)_xol,},
  {"XOver High","XOH","[Hz]", "",0,10000, 2,  6000, 0,true,true,false,kFloat,(void*)_xoh,},

  {"RT60",         "RT60","[s]", "", 0.2,15,  2, 2.5,  0,true,true,false,kFloat,(void*)_rt60,},
  {"RT60 Gain Low", "RTL","[x]", "", 0, 5,    2, 1.3,  0,true,true,false,kFloat,(void*)_rtl,},
  {"RT60 Gain High","RTH","[x]", "", 0, 2,    2, 0.25, 0,true,true,false,kFloat,(void*)_rth,},

  {"Output LPF","ODamp","[Hz]", "", 0,20000, 2, 7400, 0,true,true,false,kFloat,(void*)_odamp,},
  {"Output HPF","ODamH","[Hz]", "", 0,20000, 2,    5, 0,true,true,false,kFloat,(void*)_odamh,},
...
static void mod_samples(pfloat_t * iL, pfloat_t * iR, pfloat_t * oL, pfloat_t * oR, gint length, gint srate)
{
  ...
  if(currentfs != srate)
    {
      fprintf(stderr, "zrev2.cpp: mod_samples: Fs %d -> %d, resetAll\n", currentfs, srate);
      currentfs = srate;
      DSP.setOSFactor(DSP.getOSFactor());
      DSP.setSampleRate(srate);
      fprintf(stderr, "zrev2.cpp: mod_samples: SRCFactor: %ld\n", DSP.getOSFactor());
    }
